...
namespace Microclean.ProviderLayer.Handlers.Commands
{
    ...
    public class CreateNewCompanyUserCommandHandler : BaseRequest, IRequestHandler<CreateNewCompanyUserCommand, IActionResult>
    {
        private readonly IAccountRepository _account;
        private readonly IMapper _mapper;

        public CreateNewCompanyUserCommandHandler(IAccountRepository account, IMapper mapper)
        {
            _account = account;
            _mapper = mapper;
        }
        ...
        public async Task<IActionResult> Handle(CreateNewCompanyUserCommand request, CancellationToken cancellationToken)
        {
