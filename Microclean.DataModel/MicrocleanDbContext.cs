using Microclean.DataModel.DataModel;
using Microclean.DataModel.Models;
using Microsoft.EntityFrameworkCore;

namespace Microclean.DataModel
{
    public partial class MicrocleanDbContext : DbContext
    {
        public MicrocleanDbContext(DbContextOptions<MicrocleanDbContext> options)
            : base(options)
        {
        }
        ...
        public virtual DbSet<EmployeeAsignViewDataModel> EmployeeDataModel { get; set; }
