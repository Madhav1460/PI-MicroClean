...
{
    public partial class microcleanportaldbContext : DbContext
    {
        public microcleanportaldbContext()
        {
        }

        public microcleanportaldbContext(DbContextOptions<microcleanportaldbContext> options)
            : base(options)
        {
        }
